In a successful CSRF attack, the attacker causes the victim user to carry out an action [unintentionally](https://translate.google.com/?sl=en&tl=ar&text=unintentionally&op=translate). 
