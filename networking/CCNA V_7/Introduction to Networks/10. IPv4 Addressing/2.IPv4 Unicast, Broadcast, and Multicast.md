...
A broadcast packet has a destination IP address with all ones (1s) in the host portion, or 32 one (1) bits `11111111.11111111.11111111.11111111` (limited broad cast).

**Note:** ==there are no broadcast packets with IPv6.==
...
![[Pasted image 20250118161940.png]]

![[Pasted image 20250118161832.png]]
![[Pasted image 20250118161850.png]]
### IP Directed Broadcasts

In addition to the `255.255.255.255` broadcast address, there is a broadcast IPv4 address for each network. 

Called a directed broadcast, this address uses the highest address in the network, which is the address where all the host bits are 1s. 
...
![[Pasted image 20250118162700.png]]
